...
class DiagnosisPage extends StatefulWidget {
  ...
  const DiagnosisPage({Key? key, required this.maLH}) : super(key: key);
...
class _DiagnosisPageState extends State<DiagnosisPage> {
        ...
        child: Padding(
          ...
          child: Form(
            child: Column(
              ...
              children: [
                Text(
                  "Khách hàng: ${diagnosis?['customerName']}",
                ...
                Row(
                  ...
                  children: [
                    ...
                    Expanded(
                      child: Text(
                        diagnosis?['kqKham'] ?? "",
                        // Use the 'ketQuaKham' value from the diagnosis map
                ...
                Row(
                  ...
                  children: [
                    ...
                    Expanded(
                      child: Text(
                        diagnosis?['donThuoc'] ?? "",
                        // Use the 'donThuoc' value from the diagnosis map
                        style: TextStyle(fontSize: 18),
                      ),
                    ),
                  ],
  ...
  Future<void> _getDiagnosis() async {
    ...
    dynamic response = await ApiServiceGetDiagnosis.get_diagnosis(malh);
    setState(() {
      diagnosis = response;
    });
    print(diagnosis);
