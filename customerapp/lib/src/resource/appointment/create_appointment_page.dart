...
class _CreateCalendarPageState extends State<CreateCalendarPage> {
  ...
  void initState() {
    ...
    // Tạo danh sách các giờ cách nhau 30 phút bắt đầu từ giờ gần nhất
                ...
                itemBuilder: (context, index) {
                  ...
                  return GestureDetector(
                    ...
                    child: Container(
                      ...
                      // Độ rộng ô khung giờ
                      height: 50,
                      // Chiều cao ô khung giờ
                      alignment: Alignment.center,
                      margin: EdgeInsets.symmetric(horizontal: 5),
                      // Khoảng cách giữa các ô khung giờ
                      decoration: BoxDecoration(
                        color: _selectedHour == hour
                            ? Colors.lightBlue
                            : Colors
                                .white, // Màu nền của ô khung giờ khi được chọn
                        borderRadius: BorderRadius.circular(5),
                        border: Border.all(
                            color: Colors.lightBlue,
                            width: 1), // Viền xung quanh ô khung giờ
                      ),
                      child: Text(hour),
                    ),
                  );
