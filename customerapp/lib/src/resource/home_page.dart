...
class _HomePageState extends State<HomePage> {
                            ...
                            child: ListTile(
                                ...
                                subtitle: Column(
                                  ...
                                  children: [
                                    ...
                                    Text(
                                        'Chuyên khoa: ${doctors['chuyenKhoa']}'),
                                    /*       Row(
                                    children: [
  ...
  Future<void> _checkCurrentTime() async {
    ...
    for (var appointment in AppointmentToday) {
      String timeString = appointment['time'];
      List<String> parts = timeString.split(':');
      int appointmentHour = int.parse(parts[0]);
